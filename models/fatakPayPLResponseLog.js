...
const TABLE_NAME = 'fatakpay_pl__response_logs';
...
const SOURCES = process.env.FATAKPAYPL_SOURCES?.split(',').map(s => s.trim()).filter(Boolean)
...
module.exports = FatakPayResponseLogPL;