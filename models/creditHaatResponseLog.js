...
const TABLE_NAME = 'credithaat_response_logs';

class CreditHaatResponseLog {
    ...
    // ─── Find by leadId  (uses leadId-index) ───────────────────────────────────
    ...
    static _extractStatus(item) {
        ...
        try {
            ...
            // CreditHaat: success when code === 200
            ...
            // DynamoDB-typed formats
            if (body.Status && body.Status.S) return body.Status.S;
    ...
    static async updateFromCSV(logId, data) {
        ...
        const csvFields = [
            'chCustomerId', 'chRegisterTime', 'chProduct', 'chMaxLoanAmount',
            'chApplicationLink', 'chMobileNumber', 'chStatus', 'chRejectReason',
...
module.exports = CreditHaatResponseLog;